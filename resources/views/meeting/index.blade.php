                    ...
                    <table class="table text-sm font-medium text-gray-700 align-middle table-auto table-border"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="min-w-[170px]" data-datatable-column="meeting_type">
                                    <span class="sort">
                                        <span class="sort-label">Kategori</span>
                                        <span class="sort-icon"></span>
                                    </span>
                                </th>
                                <th class="min-w-[260px]" data-datatable-column="title">
                                    <span class="sort">
                                        <span class="sort-label">Judul</span>
                                        <span class="sort-icon"></span>
                                    </span>
                                </th>
                                ...
                                <th class="min-w-[220px]" data-datatable-column="status">
                                    <span class="sort">
                                        <span class="sort-label">Status</span>
                                        <span class="sort-icon"></span>
                                    </span>
                                </th>
                                <th class="min-w-[90px]" data-datatable-column="participants_count">
                                    <span class="sort">
                                        <span class="sort-label">Peserta</span>
                                        <span class="sort-icon"></span>
                                    </span>
                                </th>
                                <th class="min-w-[90px]" data-datatable-column="agendas_count">
                                    <span class="sort">
                                        <span class="sort-label">Agenda</span>
                                        <span class="sort-icon"></span>
                                    </span>
                                </th>
