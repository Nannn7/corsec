...
@section('breadcrumbs')
    {{ Breadcrumbs::render('corsec.sender') }}
@endsection
                ...
                <div class="flex flex-wrap gap-2 lg:gap-5">
                    <div class="flex">
                        <label class="input input-sm"> <i class="ki-filled ki-magnifier"> </i>
                            <input placeholder="Search Sender" id="search" type="text" value="">
                        </label>
                    </div>
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="min-w-[100px]" data-datatable-column="code">
                                    <span class="sort"> <span class="sort-label"> Kode Sender </span>
                                        <span class="sort-icon"> </span> </span>
                                </th>
                                <th class="min-w-[250px]" data-datatable-column="name">
                                    <span class="sort"> <span class="sort-label"> Nama Sender </span>
                                        <span class="sort-icon"> </span> </span>
                                </th>
...
@push('scripts')
        ...
        function deleteSelectedRows() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax('{{ route('sender.deleteMultiple') }}', {
                        type: 'POST',
                        data: {
                            ids: ids
                        }
    ...
    <script type="module">
        const element = document.querySelector('#sender-table');
            ...
            columns: {
                ...
                actions: {
                    ...
                    render: (item, data) => {
                        ...
                        @can('sender.update')
                            html += `<a class="btn btn-sm btn-icon btn-clear btn-info" href="sender/${data.id}/edit">
